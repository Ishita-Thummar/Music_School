  ...
  return (
    <BackgroundBeamsWithCollision>
      <div className="relative z-10 max-w-xl w-full bg-black bg-opacity-30 backdrop-blur-sm p-8 rounded-xl shadow-xl">
        <h1 className="text-4xl md:text-6xl text-center font-bold mb-6 text-white ">
          Contact Us
        </h1>
        ...
        <form className="space-y-6">
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              className="bg-cyan-400 hover:bg-cyan-500 text-black font-semibold px-6 py-3 rounded-md transition duration-300 shadow-lg "
            >
              Send Message
            </button>
          </div>
